; Converted from the source that comes with Arkos Tracker, which is written
...
;
; PlayerAkm.asm and everything it contains is
;
;   MIT License
...
PLY_AKM_HardwareCounter = PLY_AKM_HardwareCounter + 1
                IFNDEF PLY_AKM_HARDWARE_PSG_1789773_HZ
                DEFINE PLY_AKM_HARDWARE_PSG_1789773_HZ 1
                ENDIF
                IFNDEF PLY_AKM_HARDWARE_SPECTRUM_OR_MSX
                DEFINE PLY_AKM_HARDWARE_SPECTRUM_OR_MSX 1
                ENDIF
        ENDIF
        IFDEF PLY_AKM_HARDWARE_SPECTRUM
PLY_AKM_HardwareCounter = PLY_AKM_HardwareCounter + 1
                IFNDEF PLY_AKM_HARDWARE_PSG_1773400_HZ
                DEFINE PLY_AKM_HARDWARE_PSG_1773400_HZ 1
                ENDIF
                IFNDEF PLY_AKM_HARDWARE_SPECTRUM_OR_PENTAGON
                DEFINE PLY_AKM_HARDWARE_SPECTRUM_OR_PENTAGON 1
                ENDIF
                IFNDEF PLY_AKM_HARDWARE_SPECTRUM_OR_MSX
                DEFINE PLY_AKM_HARDWARE_SPECTRUM_OR_MSX 1
                ENDIF
...
PLY_AKM_HardwareCounter = PLY_AKM_HardwareCounter + 1
                IFNDEF PLY_AKM_HARDWARE_PSG_1750000_HZ
                DEFINE PLY_AKM_HARDWARE_PSG_1750000_HZ 1
                ENDIF
                IFNDEF PLY_AKM_HARDWARE_SPECTRUM_OR_PENTAGON
                DEFINE PLY_AKM_HARDWARE_SPECTRUM_OR_PENTAGON 1
                ENDIF
        ...
        IF PLY_AKM_HardwareCounter == 0
                IFNDEF PLY_AKM_HARDWARE_CPC
                DEFINE PLY_AKM_HARDWARE_CPC 1
                ENDIF
        ENDIF

        IFDEF PLY_AKM_HARDWARE_CPC
                IFNDEF PLY_AKM_HARDWARE_PSG_1000000_HZ
                DEFINE PLY_AKM_HARDWARE_PSG_1000000_HZ 1
                ENDIF
        ENDIF
...
disarkCounter = 0       ;Consider this macro is always declared when others are, so reset the counter for all of them.
        ...
        IFNDEF PLY_CFG_ConfigurationIsPresent
                IFNDEF PLY_CFG_UseTranspositions
                DEFINE PLY_CFG_UseTranspositions 1
                ENDIF
                IFNDEF PLY_CFG_UseSpeedTracks
                DEFINE PLY_CFG_UseSpeedTracks 1
                ENDIF
                IFNDEF PLY_CFG_UseEffects
                DEFINE PLY_CFG_UseEffects 1
                ENDIF
                IFNDEF PLY_CFG_UseHardwareSounds
                DEFINE PLY_CFG_UseHardwareSounds 1
                ENDIF
                IFNDEF PLY_CFG_NoSoftNoHard_Noise
                DEFINE PLY_CFG_NoSoftNoHard_Noise 1
                ENDIF
                IFNDEF PLY_CFG_SoftOnly_Noise
                DEFINE PLY_CFG_SoftOnly_Noise 1
                ENDIF
                IFNDEF PLY_CFG_SoftOnly_SoftwarePitch
                DEFINE PLY_CFG_SoftOnly_SoftwarePitch 1
                ENDIF
                IFNDEF PLY_CFG_SoftToHard_SoftwarePitch
                DEFINE PLY_CFG_SoftToHard_SoftwarePitch 1
                ENDIF
                IFNDEF PLY_CFG_SoftToHard_SoftwareArpeggio
                DEFINE PLY_CFG_SoftToHard_SoftwareArpeggio 1
                ENDIF
                IFNDEF PLY_CFG_SoftAndHard_SoftwarePitch
                DEFINE PLY_CFG_SoftAndHard_SoftwarePitch 1
                ENDIF
                IFNDEF PLY_CFG_SoftAndHard_SoftwareArpeggio
                DEFINE PLY_CFG_SoftAndHard_SoftwareArpeggio 1
                ENDIF
                IFNDEF PLY_CFG_UseEffect_ArpeggioTable
                DEFINE PLY_CFG_UseEffect_ArpeggioTable 1
                ENDIF
                IFNDEF PLY_CFG_UseEffect_ForcePitchTableSpeed
                DEFINE PLY_CFG_UseEffect_ForcePitchTableSpeed 1
                ENDIF
                IFNDEF PLY_CFG_UseEffect_ForceArpeggioSpeed
                DEFINE PLY_CFG_UseEffect_ForceArpeggioSpeed 1
                ENDIF
                IFNDEF PLY_CFG_UseEffect_ForceInstrumentSpeed
                DEFINE PLY_CFG_UseEffect_ForceInstrumentSpeed 1
                ENDIF
                IFNDEF PLY_CFG_UseEffect_PitchUp
                DEFINE PLY_CFG_UseEffect_PitchUp 1
                ENDIF
                IFNDEF PLY_CFG_UseEffect_PitchDown
                DEFINE PLY_CFG_UseEffect_PitchDown 1
                ENDIF
                IFNDEF PLY_CFG_UseEffect_PitchTable
                DEFINE PLY_CFG_UseEffect_PitchTable 1
                ENDIF
                IFNDEF PLY_CFG_UseEffect_SetVolume
                DEFINE PLY_CFG_UseEffect_SetVolume 1
                ENDIF
                IFNDEF PLY_CFG_UseEffect_Reset
        ...
        IFDEF PLY_CFG_SoftOnly_SoftwarePitch
                IFNDEF PLY_AKM_PitchInInstrument
                DEFINE PLY_AKM_PitchInInstrument 1
                ENDIF
        ENDIF
        IFDEF PLY_CFG_SoftToHard_SoftwarePitch
                ...
                DEFINE PLY_AKM_PitchInInstrument 1
                ENDIF
                IFNDEF PLY_AKM_PitchInHardwareInstrument
                DEFINE PLY_AKM_PitchInHardwareInstrument 1
                ENDIF
        ENDIF
        ...
        IFDEF PLY_CFG_SoftOnly_SoftwareArpeggio
                IFNDEF PLY_AKM_ArpeggioInSoftwareOrHardwareInstrument
                DEFINE PLY_AKM_ArpeggioInSoftwareOrHardwareInstrument 1
                ENDIF
        ENDIF
        IFDEF PLY_CFG_SoftToHard_SoftwareArpeggio
                ...
                DEFINE PLY_AKM_ArpeggioInSoftwareOrHardwareInstrument 1
                ENDIF
                IFNDEF PLY_AKM_ArpeggioInHardwareInstrument
                DEFINE PLY_AKM_ArpeggioInHardwareInstrument 1
                ENDIF
        ENDIF
        ...
        IFDEF PLY_CFG_NoSoftNoHard_Noise
                IFNDEF PLY_AKM_USE_Noise
                DEFINE PLY_AKM_USE_Noise 1
                ENDIF
        ENDIF
        ...
        IFDEF PLY_AKM_USE_Noise
                IFNDEF PLY_AKM_USE_NoiseRegister
                DEFINE PLY_AKM_USE_NoiseRegister 1
                ENDIF
        ENDIF
        
        ;Mixing Pitch up/down effects.
        IFDEF PLY_CFG_UseEffect_PitchUp
                IFNDEF PLY_AKM_USE_EffectPitchUpDown
                DEFINE PLY_AKM_USE_EffectPitchUpDown 1
                ENDIF
        ENDIF
...
counter = 0
        ...
        IFDEF PLY_AKM_Rom
PLY_AKM_PtInstruments: dw 0
PLY_AKM_PtArpeggios: dw 0
PLY_AKM_PtPitches: dw 0
PLY_AKM_PtLinker: dw 0
PLY_AKM_NoteIndexTable: dw 0
PLY_AKM_TrackIndex: dw 0
PLY_AKM_SaveSP: dw 0
        
PLY_AKM_DefaultStartNoteInTracks: db 0
PLY_AKM_DefaultStartInstrumentInTracks: db 0
PLY_AKM_DefaultStartWaitInTracks: db 0
PLY_AKM_PrimaryInstrument: db 0
PLY_AKM_SecondaryInstrument: db 0
PLY_AKM_PrimaryWait: db 0
PLY_AKM_SecondaryWait: db 0
PLY_AKM_FlagNoteAndEffectInCell: db 0
        
PLY_AKM_PatternRemainingHeight: db 0
PLY_AKM_LinkerPreviousRemainingHeight: db 0
PLY_AKM_Speed: db 0
PLY_AKM_TickCounter: db 0
PLY_AKM_SetReg13Old: db 0
PLY_AKM_SetReg13: db 0
PLY_AKM_RT_ReadEffectsFlag: db 0
...
PLY_AKM_Registers_RetTable equ PLY_AKM_ROM_Buffer + counter
        ;Reg 8.
PLY_AKM_Track1_Registers: db 0
PLY_AKM_Track1_Volume: db 0
PLY_AKM_Track1_VolumeRet: dw 0
        ;Reg 0.
PLY_AKM_Track1_SoftwarePeriodLSBRegister: db 0
PLY_AKM_Track1_SoftwarePeriodLSB: db 0
PLY_AKM_Track1_SoftwarePeriodLSBRet: dw 0
        ;Reg 1.
PLY_AKM_Track1_SoftwarePeriodMSBRegister: db 0
PLY_AKM_Track1_SoftwarePeriodMSB: db 0
PLY_AKM_Track1_SoftwarePeriodMSBRet: dw 0
        
        ;Reg 9.
PLY_AKM_Track2_Registers: db 0
PLY_AKM_Track2_Volume: db 0
PLY_AKM_Track2_VolumeRet: dw 0
        ;Reg 2.
PLY_AKM_Track2_SoftwarePeriodLSBRegister: db 0
PLY_AKM_Track2_SoftwarePeriodLSB: db 0
PLY_AKM_Track2_SoftwarePeriodLSBRet: dw 0
        ;Reg 3.
PLY_AKM_Track2_SoftwarePeriodMSBRegister: db 0
PLY_AKM_Track2_SoftwarePeriodMSB: db 0
PLY_AKM_Track2_SoftwarePeriodMSBRet: dw 0
        
        ;Reg 10.
PLY_AKM_Track3_Registers: db 0
PLY_AKM_Track3_Volume: db 0
PLY_AKM_Track3_VolumeRet: dw 0
        ;Reg 4.
PLY_AKM_Track3_SoftwarePeriodLSBRegister: db 0
PLY_AKM_Track3_SoftwarePeriodLSB: db 0
PLY_AKM_Track3_SoftwarePeriodLSBRet: dw 0
        ;Reg 5.
PLY_AKM_Track3_SoftwarePeriodMSBRegister: db 0
PLY_AKM_Track3_SoftwarePeriodMSB: db 0
PLY_AKM_Track3_SoftwarePeriodMSBRet: dw 0
        
        IFDEF PLY_AKM_USE_NoiseRegister          ;CONFIG SPECIFIC
                ;Reg 6.
PLY_AKM_NoiseRegisterPlaceholder: db 0
PLY_AKM_NoiseRegister: db 0      ;Misnomer: this is the value.
PLY_AKM_NoiseRegisterRet: dw 0
        ENDIF
        
        ;Reg 7.
PLY_AKM_MixerRegisterPlaceholder: db 0
PLY_AKM_MixerRegister: db 0      ;Misnomer: this is the value.
        IFDEF PLY_CFG_UseHardwareSounds         ;CONFIG SPECIFIC
PLY_AKM_MixerRegisterRet: dw 0
                ;Reg 11.
PLY_AKM_Reg11Register: db 0
PLY_AKM_Reg11: db 0
PLY_AKM_Reg11Ret: dw 0
                ;Reg 12.
PLY_AKM_Reg12Register: db 0
PLY_AKM_Reg12: db 0
PLY_AKM_Reg12Ret: dw 0
                ;This one is a trick to send the register after R13 is managed.
PLY_AKM_Reg12Ret2: dw 0
        ENDIF
        
PLY_AKM_RegsFinalRet: dw 0
        
        
        ;The buffers for sound effects (if any), for each channel. They are treated apart, because they must be consecutive.
                IFDEF PLY_AKM_MANAGE_SOUND_EFFECTS
PLY_AKM_PtSoundEffectTable: dw 0
                        REPEAT 3, channelNumber, 1
PLY_AKM_Channel{channelNumber}_SoundEffectData: dw 0
PLY_AKM_Channel{channelNumber}_SoundEffectInvertedVolume: db 0
PLY_AKM_Channel{channelNumber}_SoundEffectCurrentStep: db 0
PLY_AKM_Channel{channelNumber}_SoundEffectSpeed: db 0
                if channelNumber != 3
...
counterStartInTrackData = counter                    ;Duplicates the counter value to determine later the size of the track buffer.
        ENDIF
PLY_AKM_Track1_WaitEmptyCell: db 0      ;How many empty cells have to be waited. 0 = none.
        IFDEF PLY_AKM_Rom
...
PLY_AKM_Track1_Transposition: db 0
                        ENDIF ;PLY_CFG_UseTranspositions
PLY_AKM_Track1_PtStartTrack: dw 0      ;Points at the start of the Track to read. Does not change, unless the Track changes.
PLY_AKM_Track1_PtTrack: dw 0      ;Points on the next Cell of the Track to read. Evolves.
PLY_AKM_Track1_BaseNote: db 0      ;Base note, such as the note played. The transposition IS included.
PLY_AKM_Track1_EscapeNote: db 0      ;The escape note. The transposition is NOT included.
PLY_AKM_Track1_EscapeInstrument: db 0      ;The escape instrument.
PLY_AKM_Track1_EscapeWait: db 0      ;The escape wait.
PLY_AKM_Track1_PtInstrument: dw 0      ;Points on the Instrument, evolves.
PLY_AKM_Track1_InstrumentCurrentStep: db 0      ;The current step on the Instrument (>=0, till it reaches the Speed).
PLY_AKM_Track1_InstrumentSpeed: db 0      ;The Instrument speed (>=0).
                        IFDEF PLY_CFG_UseEffect_SetVolume        ;CONFIG SPECIFIC
PLY_AKM_Track1_TrackInvertedVolume: db 0
                        ENDIF ;PLY_CFG_UseEffect_SetVolume
                        IFDEF PLY_AKM_USE_EffectPitchUpDown        ;CONFIG SPECIFIC
PLY_AKM_Track1_IsPitchUpDownUsed: db 0      ;>0 if a Pitch Up/Down is currently in use.
PLY_AKM_Track1_TrackPitchInteger: dw 0      ;The integer part of the Track pitch. Evolves as the pitch goes up/down.
PLY_AKM_Track1_TrackPitchDecimal: db 0      ;The decimal part of the Track pitch. Evolves as the pitch goes up/down.
PLY_AKM_Track1_TrackPitchSpeed: dw 0      ;The integer and decimal part of the Track pitch speed. Is added to the Track Pitch every frame.
                        ENDIF ;PLY_AKM_USE_EffectPitchUpDown
                        IFDEF PLY_CFG_UseEffect_ArpeggioTable        ;CONFIG SPECIFIC
PLY_AKM_Track1_IsArpeggioTableUsed: db 0      ;>0 if an Arpeggio Table is currently in use.
PLY_AKM_Track1_PtArpeggioTable: dw 0      ;Point on the base of the Arpeggio table, does not evolve.
PLY_AKM_Track1_PtArpeggioOffset: db 0      ;Increases over the Arpeggio.
PLY_AKM_Track1_ArpeggioCurrentStep: db 0      ;The arpeggio current step (>=0, increases).
                                IFDEF PLY_CFG_UseEffect_ForceArpeggioSpeed        ;CONFIG SPECIFIC
PLY_AKM_Track1_ArpeggioCurrentSpeed: db 0      ;The arpeggio speed (>=0, may be changed by the Force Arpeggio Speed effect).
                                ENDIF ;PLY_CFG_UseEffect_ForceArpeggioSpeed
PLY_AKM_Track1_ArpeggioOriginalSpeed: db 0      ;The arpeggio original speed (>=0, NEVER changes for this arpeggio).
PLY_AKM_Track1_CurrentArpeggioValue: db 0      ;Value from the Arpeggio to add to the base note. Read even if the Arpeggio effect is deactivated.
                        ENDIF ;PLY_CFG_UseEffect_ArpeggioTable
                        IFDEF PLY_CFG_UseEffect_PitchTable        ;CONFIG SPECIFIC
PLY_AKM_Track1_IsPitchTableUsed: db 0      ;>0 if a Pitch Table is currently in use.
PLY_AKM_Track1_PtPitchTable: dw 0      ;Points on the base of the Pitch table, does not evolve.
PLY_AKM_Track1_PtPitchOffset: db 0      ;Increases over the Pitch.
PLY_AKM_Track1_PitchCurrentStep: db 0      ;The Pitch current step (>=0, increases).
                                IFDEF PLY_CFG_UseEffect_ForcePitchTableSpeed        ;CONFIG SPECIFIC
PLY_AKM_Track1_PitchCurrentSpeed: db 0      ;The Pitch speed (>=0, may be changed by the Force Pitch Speed effect).
                                ENDIF ;PLY_CFG_UseEffect_ForcePitchTableSpeed
PLY_AKM_Track1_PitchOriginalSpeed: db 0      ;The Pitch original speed (>=0, NEVER changes for this pitch).
PLY_AKM_Track1_CurrentPitchTableValue: dw 0      ;16 bit value from the Pitch to add to the base note. Not read if the Pitch effect is deactivated.
