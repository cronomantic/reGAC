...
;
; PlayerAkm_SoundEffects.asm and everything it contains is
;
;   MIT License
...
;       Note that this is the exact same code as for the Lightweight player, as the way to output to the PSG is the same.
        ...
        IFNDEF PLY_CFG_SFX_ConfigurationIsPresent
                IFNDEF PLY_CFG_SFX_LoopTo
                DEFINE PLY_CFG_SFX_LoopTo 1
                ENDIF
                IFNDEF PLY_CFG_SFX_NoSoftNoHard
                DEFINE PLY_CFG_SFX_NoSoftNoHard 1
                ENDIF
                IFNDEF PLY_CFG_SFX_NoSoftNoHard_Noise
                DEFINE PLY_CFG_SFX_NoSoftNoHard_Noise 1
                ENDIF
                IFNDEF PLY_CFG_SFX_SoftOnly
                DEFINE PLY_CFG_SFX_SoftOnly 1
                ENDIF
                IFNDEF PLY_CFG_SFX_SoftOnly_Noise
                DEFINE PLY_CFG_SFX_SoftOnly_Noise 1
                ENDIF
                IFNDEF PLY_CFG_SFX_HardOnly
                DEFINE PLY_CFG_SFX_HardOnly 1
                ENDIF
                IFNDEF PLY_CFG_SFX_HardOnly_Noise
                DEFINE PLY_CFG_SFX_HardOnly_Noise 1
                ENDIF
                IFNDEF PLY_CFG_SFX_HardOnly_Retrig
                DEFINE PLY_CFG_SFX_HardOnly_Retrig 1
                ENDIF
                IFNDEF PLY_CFG_SFX_SoftAndHard
                DEFINE PLY_CFG_SFX_SoftAndHard 1
                ENDIF
                IFNDEF PLY_CFG_SFX_SoftAndHard_Noise
                DEFINE PLY_CFG_SFX_SoftAndHard_Noise 1
                ENDIF
                IFNDEF PLY_CFG_SFX_SoftAndHard_Retrig
                DEFINE PLY_CFG_SFX_SoftAndHard_Retrig 1
                ENDIF
        ENDIF
...
;       Mixes the Hardware flags into one.
        IFDEF PLY_CFG_SFX_HardOnly
                IFNDEF PLY_AKM_SE_HardwareSounds
                DEFINE PLY_AKM_SE_HardwareSounds 1
                ENDIF
        ENDIF
...
;       Mixes the Hardware Noise flags into one.
        IFDEF PLY_CFG_SFX_HardOnly_Noise
                IFNDEF PLY_AKM_SE_HardwareNoise
                DEFINE PLY_AKM_SE_HardwareNoise 1
                ENDIF
        ENDIF
...
;       Mixes the Noise flags into one.
        IFDEF PLY_AKM_SE_HardwareNoise
                IFNDEF PLY_AKM_SE_Noise
                DEFINE PLY_AKM_SE_Noise 1
                ENDIF
        ENDIF
...
;       Mixes the Software Volume flags into one.
        IFDEF PLY_CFG_SFX_NoSoftNoHard
                IFNDEF PLY_AKM_SE_VolumeSoft
                DEFINE PLY_AKM_SE_VolumeSoft 1
                ENDIF
                IFNDEF PLY_AKM_SE_VolumeSoftOrHard
                DEFINE PLY_AKM_SE_VolumeSoftOrHard 1
                ENDIF
        ENDIF
        IFDEF PLY_CFG_SFX_SoftOnly
                IFNDEF PLY_AKM_SE_VolumeSoft
...
;       Mixes the volume (soft/hard) into one.
        IFDEF PLY_AKM_SE_HardwareSounds
                IFNDEF PLY_AKM_SE_VolumeSoftOrHard
                DEFINE PLY_AKM_SE_VolumeSoftOrHard 1
                ENDIF
        ENDIF
;       Mixes the retrig flags into one.
        IFDEF PLY_CFG_SFX_HardOnly_Retrig
                IFNDEF PLY_AKM_SE_Retrig
                DEFINE PLY_AKM_SE_Retrig 1
                ENDIF
        ENDIF
        ...
        IFDEF PLY_AKM_SE_HardwareSounds
                ;If the SFXs have hardware sounds, the main song must also have them.
