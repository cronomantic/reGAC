...
;
; Putting points and lines on an Amstrad, in mode 1, with the Amstrad's own
; rules: the ones a picture written on this machine was drawn with.  A picture
; off a Spectrum is drawn with the Spectrum's instead -- spectrum.asm -- and a
; build carries one or the other.  Where a point is on the screen is in
; pixels.asm, which both use.
;
